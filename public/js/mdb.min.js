                    ...
                    if (v.State.calls[o]) {
                        ...
                        for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
                            ...
                            if (a(C)) {
                                ...
                                k)
                                    if ("element" !== M) {
                                        var T, P = k[M], I = p.isString(P.easing) ? v.Easings[P.easing] : P.easing;
                                        if (1 === g)
                                            T = P.endValue;
                                        else {
                                            var A = P.endValue - P.startValue;
                                            if (T = P.startValue + A * I(g, d, A),
                                            !f && T === P.currentValue)
                                                continue
                                        }
                                        if (P.currentValue = T,
            ...
            var x = function() {
                ...
                function r() {
                    function t(t) {
                        ...
                        if ("scroll" === T) {
                            var x, k, M, I = /^x$/i.test(c.axis) ? "Left" : "Top", A = parseFloat(c.offset) || 0;
                            c.container ? p.isWrapped(c.container) || p.isNode(c.container) ? (c.container = c.container[0] || c.container,
                            M = (x = c.container["scroll" + I]) + u(r).position()[I.toLowerCase()] + A) : c.container = null : (x = v.State.scrollAnchor[v.State["scrollProperty" + I]],
                            k = v.State.scrollAnchor[v.State["scrollProperty" + ("Left" === I ? "Top" : "Left")]],
                            ...
                            y) {
                                ...
                                if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                                    (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(E) && !V && 0 !== F && (V = 0),
                                    ...
                                    if (V = (H = f(E, V))[0],
                                    B = H[1],
                                    F = (H = f(E, F))[0].replace(/^([+-\/*])=/, function(t, e) {
                                        return Y = e,
                                        ""
                                    }),
                                    j = H[1],
                                    V = parseFloat(V) || 0,
                                    F = parseFloat(F) || 0,
                                    "%" === j && (/^(fontSize|lineHeight)$/.test(E) ? (F /= 100,
                                    j = "em") : /^scale/.test(E) ? (F /= 100,
                                    j = "") : /(Red|Green|Blue)$/i.test(E) && (F = F / 100 * 255,
                                    j = "")),
                                    /[\/*]/.test(Y))
                                        j = B;
                                    else if (B !== j && 0 !== V)
                        ...
                        a(r).opts = c),
                        a(r).isAnimating = !0,
                        S === C - 1 ? (v.State.calls.push([R, g, c, null, P.resolver]),
                    ...
                    !1 === c.queue ? c.delay ? setTimeout(t, c.delay) : t() : u.queue(r, c.queue, function(e, i) {
                        return !0 === i ? (P.promise && P.resolver(g),
                ...
                g = o(g)) {
                        ...
                        if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
                            if (p.isString(y) && v.Redirects[y]) {
                                ...
                                u.each(g, function(t, e) {
                                    ...
                                    E.drag && (E.duration = parseFloat(A) || (/^(callout|transition)/.test(y) ? 1e3 : m),
                            ...
                            return P.promise ? P.rejecter(new Error(_)) : console.log(_),
                            t()
                        }
                        T = "start"
                    }
                    ...
                    E.loop)
                        for (var $ = 0; D > $; $++) {
                            ...
                            $ === D - 1 && (F.display = E.display,
                            F.visibility = E.visibility,
                    ...
                    if (i.display) {
                        ...
                        if (a.each(g, function(n, o) {
                            if (!a.isNullOrUndef(n.label)) {
                                ...
                                if (m) {
                                    var V = w + W;
                                    "bottom" === i.position ? (F = f ? "middle" : "top",
                                    $ = f ? "right" : "center",
                                    L = e.top + V) : (F = f ? "middle" : "bottom",
                                    $ = f ? "left" : "center",
                                    L = e.bottom - V);
                        ...
                        p.display) {
                            ...
                            if (m)
                                ...
                                E = "bottom" === i.position ? e.bottom - R - S.bottom : e.top + R + S.top;
                            else {
                                var $ = "left" === i.position;
                                D = $ ? e.left + R + S.top : e.right - R - S.top,
                                E = e.top + (e.bottom - e.top) / 2,
                                L = $ ? -.5 * Math.PI : .5 * Math.PI
                            }
                            o.save(),
                            o.translate(D, E),
                            o.rotate(L),
                        ...
                        if (h.drawBorder) {
                            ...
                            m ? (V = z = "top" === i.position ? e.bottom : e.top,
                            V += N,
                            z += N) : (F = W = "left" === i.position ? e.right : e.left,
                            F += N,
                            W += N),
                            o.beginPath(),
                            o.moveTo(F, V),
...
$(document).ready(function() {
    ...
    $("#preloader-markup").on("load", "mdb-addons/preloader.html", function() {
        ...
        return _createClass(d, [{
            ...
            value: function(t) {
                if ("touchmove" === t.type) {
                    ...
                    "left" === this.options.edge && (i > this.options.menuWidth ? i = this.options.menuWidth : i < 0 && (i = 0)),
            ...
            value: function(t) {
                if ("touch" === t.gesture.pointerType) {
                    ...
                    this.disableScrolling(),
                    0 !== this.$sidenavOverlay.length || this.buildSidenavOverlay(),
                    "left" === this.options.edge && (e > this.options.menuWidth ? e = this.options.menuWidth : e < 0 && (e = 0)),
            ...
            value: function(t) {
                if ("left" === this.options.edge) {
                    ...
                    this.menuOut = e,
                    this.$menu.css("transform", "translateX(".concat(t - this.options.menuWidth, "px)"))
                } else {
            ...
            value: function(t) {
                var e;
                e = "left" === this.options.edge ? t / this.options.menuWidth : Math.abs((t - window.innerWidth) / this.options.menuWidth),
            ...
            value: function(t) {
                if ("touchend" === t.type) {
                    ...
                    this.translateMenuX([-1 * this.options.menuWidth - 10, o], "200"),
                    ...
                    this.translateMenuX([this.options.menuWidth + 10, a], "200"),
                    this.hideSidenavOverlay(),
                    this.$dragTarget.css({
                        width: "10px",
                        right: 0,
            ...
            value: function(t) {
                if ("touch" === t.gesture.pointerType) {
                    ...
                    this.translateMenuX([-1 * this.options.menuWidth - 10, n], "200"),
                    this.hideSidenavOverlay()),
                    this.$dragTarget.css({
                        width: "10px",
                        right: "",
                    ...
                    this.translateMenuX([this.options.menuWidth + 10, o], "200"),
                    this.hideSidenavOverlay(),
                    this.$dragTarget.css({
                        width: "10px",
                        right: 0,
            ...
            value: function() {
                ...
                this.options.menuWidth !== e && (this.$menu.css("width", this.options.menuWidth),
...
function(t) {
    var e, i = "input[type=range]:not(.custom-range):not(.multi-range)", n = !1;
    ...
    t(document).on("input mousedown touchstart", i, function(o) {
        ...
        "input" !== o.type) {
            ...
            (e = l ? o.originalEvent.touches[0].pageX - t(this).offset().left : o.pageX - t(this).offset().left) < 0 ? e = 0 : e > s && (e = s),
...
function(t) {
    var e, i = function() {
        function e(i, n) {
            ...
            this.$materialSelect = t('<input type="text" class="select-dropdown" readonly="true" '.concat(this.$nativeSelect.is(":disabled") ? "disabled" : "", ' data-activates="select-options-').concat(this.uuid, '" value=""/>')),
        ...
        return _createClass(e, [{
            ...
            value: function() {
                ...
                0 === (t = e >= 5 ? "".concat(e, " options selected") : t.substring(2)).length && (t = this.$nativeSelect.find("option:disabled").eq(0).text()),
          ...
          , y = v.prototype = {
            ...
            start: function() {
                ...
                function() {
                    ...
                    f.editable || g.on("focus." + p.id + " click." + p.id, (t = function(t) {
                        t.preventDefault(),
                        y.open()
                    }
                    ,
...
function() {
    ...
    function M(t, e) {
        var i, o, r = n(S), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"), p = r.find(".clockpicker-hours"), M = r.find(".clockpicker-minutes"), P = r.find(".clockpicker-am-pm-block"), I = "INPUT" === t.prop("tagName"), A = I ? t : t.find("input"), O = (A.prop("type"),
        ...
        A.on("focus.clockpicker click.clockpicker", m(n.proxy(this.show, this), 300));
...
function(t, e) {
    ...
    return function(t, e, i, n) {
        ...
        var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, M, T, P, I, A, O, _, D, E, L, R, $, F, W, V, z, N, H, j, B, Y, X, q, U, Q, Z, K, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
            ...
            Rt && (o.unbind(document, "mousemove", $t),
            ...
            init: function() {
                if (!s && !l) {
                    ...
                    for (F.animationName && F.transform && !n || (r.showAnimationDuration = r.hideAnimationDuration = 0),
                    i = 0; i < vt.length; i++)
                        a["init" + vt[i]]();
                    ...
                    Ct("initialZoomInEnd", function() {
                        ...
                        r.mouseUsed || o.bind(document, "mousemove", $t),
            ...
            q || X || et || H)
                ...
                H)
                    ...
                    if (!et)
                        return "swipe" !== n ? void Le() : void (!Q && g > a.currItem.fitRatio && _e(z))
                }
        }, Oe = function() {
            var t, e, i = {
                lastFlickOffset: {},
                ...
                panAnimLoop: function() {
                    return Bt.zoomPan && (Bt.zoomPan.raf = _(i.panAnimLoop),
                    i.now = Mt(),
        ...
        xt("Gestures", {
            publicMethods: {
                initGestures: function() {
                    ...
                    A ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : F.touch ? (t("touch", "start", "move", "end", "cancel"),
                ...
                initController: function() {
                    ...
                    Ct("destroy", function() {
                        for (var t, e = 0; e < $e.length; e++)
                            (t = $e[e]).container && (t.container = null),
                ...
                setContent: function(t, e) {
                    ...
                    if (l) {
                        ...
                        !l.src || l.loadError || l.loaded)
                            ...
                            if (l.loadComplete = function(i) {
                                if (s) {
                                    if (t && t.index === e) {
                                        ...
                                        i.placeholder = null) : F.transform && (et || We) ? je.push({
                                            item: i,
                                            baseDiv: c,
                                            img: i.img,
                                            index: e,
                            ...
                            l.loading || qe(l),
                            a.allowProgressiveImg() && (!Fe && F.transform ? je.push({
                                item: l,
                                baseDiv: c,
                                img: l.img,
                                index: e,
            ...
            publicMethods: {
                ...
                handleMouseWheel: function(t) {
                    if (g <= a.currItem.fitRatio)
                        return r.modal && (!r.closeOnScroll || Yt || B ? t.preventDefault() : I && Math.abs(t.deltaY) > 2 && (c = !0,
                        a.close())),
                        !0;
...
function(t) {
    t(".input-default-wrapper").on("change", ".input-default-js", function(e) {
        var i = t(e.target)
          ...
          , o = i[0].files
          , a = "";
        o && o.length > 1 ? a = (i.attr("data-multiple-target") || "").replace("{target}", o.length) : e.target.value && (a = e.target.value.split("\\").pop()),
